...
class ActivityUser extends DbObject
{
     ...
     */
    public $a_u_aw_result;

    /**
     * @ORM\Column(type="float", nullable=true)
     */
    public $a_u_ae_result;

    /**
     * @ORM\Column(type="float", nullable=true)
     */
    public $a_u_re_result;
     ...
     * @ORM\Column(type="float", nullable=true)
     */
    public $a_u_w_devratio;

    /**
     * @ORM\Column(type="float", nullable=true)
     */
    public $a_u_e_devratio;
     ...
     * @ORM\Column(type="float")
     */
    public $a_u_ivp_bonus;

    /**
     * @ORM\Column(type="float")
     */
    public $a_u_ivp_penalty;
